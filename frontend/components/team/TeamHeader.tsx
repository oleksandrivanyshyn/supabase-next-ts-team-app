...
export function TeamHeader({ teamId, me }: TeamHeaderProps) {
  ...
  const handleLeave = () =>
    leaveOrDelete(() => leaveTeam.mutateAsync(), 'You left the team');
  const handleDelete = () =>
    leaveOrDelete(() => deleteTeam.mutateAsync(), 'Team deleted');
      ...
      <AlertDialog open={leaveOpen} onOpenChange={setLeaveOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You&apos;ll lose access to this team&apos;s products until you
              rejoin with an invite code. Products you created stay with the
              team.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This permanently deletes the team and every product in it, for
              every member. This cannot be undone. Type{' '}
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={
                deleteTeam.isPending || deleteConfirmText !== team?.name
              }
            >
